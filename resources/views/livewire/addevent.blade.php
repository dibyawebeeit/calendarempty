<div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
            ...
            <tr>
                <td width="168" valign="bottom"><span class="cp"> <a href="javascript:history.back();"><img
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="frmBackground">
                                                    <form class="changeForm" wire:submit.prevent="submitEvent">
  ...
  @for ($i=1; $i < 31; $i++)
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" class="frmInput">
                                                    <input type="image"
                                                        src="{{ asset('assets/images/btnAdd.gif') }}" name="Add"
                                                        value="Add" align="middle" alt="Add">
                                                    &nbsp;<input type="image"
